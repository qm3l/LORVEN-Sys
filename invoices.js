...
function saveInvoice() {
    ...
    sessionStorage.removeItem('lorvenInvoicesvoiceState');   // 👈 إضافة
}
...
function printInvoice() {
    ...
    const customerName = document.getElementById('customerName')?.value || i18n[settings.language].customer;
        ...
        <body>
            <div class="invoice-card">
                ...
                <div class="invoice-body">
                    ...
                    <div class="summary">
                        <div class="summary-row"><span class="summary-label">التوصيل</span><span class="summary-value">${deliveryCost.toFixed(2)} ر.س</span></div>
                    </div>
